...
class ElasticSearchEngine:
    ...
    def insert(self, body):
        msg = self.es.index(self.index, body = body)
        log.INFO(msg)
...
if __name__ == "__main__":
    ...
    es.bulk_insert()
    # print(es.search_by_author("吴恩达","Department of Electrical Engineering, Stanford University/Landing AI/Deeplearning.ai/AI Fund/Coursera/Woebot Labs Inc"))